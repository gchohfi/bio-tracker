...
export const MARKERS: MarkerDef[] = [
  ...
  { id: "neutrofilos",     name: "Neutrófilos (%)", unit: "%",            category: "Hemograma",
    labRange: { M: [40, 70], F: [40, 70] }, panel: "Padrão" },
  ...
  { id: "bastonetes",      name: "Bastonetes",      unit: "%",            category: "Hemograma",
    labRange: { M: [0, 5], F: [0, 5] }, panel: "Adicional" },
  ...
  { id: "linfocitos",      name: "Linfócitos (%)",  unit: "%",            category: "Hemograma",
    labRange: { M: [20, 45], F: [20, 45] }, panel: "Padrão" },
  ...
  // ── Andrógenos ────────────────────────────────────────────────────────────
  { id: "dihidrotestosterona", name: "Dihidrotestosterona", unit: "ng/dL", category: "Andrógenos",
    labRange: { M: [25, 99], F: [5, 46] }, panel: "Padrão" },
  ...
  { id: "fator_reumatoide", name: "Fator Reumatoide", unit: "UI/mL",      category: "Imunologia",
    labRange: { M: [0, 14], F: [0, 14] }, panel: "Adicional" },
  ...
  { id: "anti_hbs",        name: "Anti-HBs (Hepatite B)", unit: "UI/L",  category: "Sorologia",
    labRange: { M: [10, 999], F: [10, 999] }, panel: "Adicional" },
  ...
  { id: "toxoplasma_igg",  name: "Toxoplasma IgG",  unit: "UI/mL",        category: "Sorologia",
    labRange: { M: [0, 1.6], F: [0, 1.6] }, panel: "Adicional" },
  ...
  { id: "vzv_igg",         name: "Varicella-Zoster IgG", unit: "mIU/mL", category: "Sorologia",
    labRange: { M: [165, 999999], F: [165, 999999] }, panel: "Adicional" },
  ...
  { id: "urina_densidade", name: "Densidade",        unit: "",             category: "Urina",
    labRange: { M: [1.005, 1.030], F: [1.005, 1.030] }, panel: "Padrão" },

  { id: "urina_ph",        name: "pH Urinário",      unit: "",             category: "Urina",
    labRange: { M: [5.0, 8.0], F: [5.0, 8.0] }, panel: "Padrão" },
  ...
  // Note: urina_hemacias_quant ref is "<= 23.000 /mL" (Fleury standard)
  ...
  { id: "urina_creatinina", name: "Creatinina (urina)", unit: "mg/dL",    category: "Urina",
    labRange: { M: [50, 300], F: [50, 300] }, panel: "Padrão" },
...
export function getMarkerStatusFromRef(
  ...
  // Lab references use inclusive semantics: "< X" means "up to X" (≤),
  // "> X" means "at least X" (≥). This matches clinical convention.
  if (operator === '<=' || operator === '<') {
