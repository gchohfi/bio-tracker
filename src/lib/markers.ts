...
export const MARKERS: MarkerDef[] = [
  ...
  { id: "fator_reumatoide", name: "Fator Reumatoide", unit: "UI/mL", category: "Imunologia", refRange: { M: [0, 14], F: [0, 14] } },
  { id: "anti_endomisio_iga", name: "Anti-Endomísio IgA", unit: "", category: "Imunologia", refRange: { M: [0, 0], F: [0, 0] }, qualitative: true },
  { id: "anti_transglutaminase_iga", name: "Anti-Transglutaminase IgA", unit: "U", category: "Imunologia", refRange: { M: [0, 20], F: [0, 20] } },
  { id: "g6pd", name: "G6PD (Glicose-6-Fosfato Desidrogenase)", unit: "U/g Hb", category: "Imunologia", refRange: { M: [6.7, 999], F: [6.7, 999] } },
  // Sorologia Infecciosa
  { id: "hiv", name: "HIV 1/2 (Anticorpos e Antígeno)", unit: "", category: "Sorologia", refRange: { M: [0, 0], F: [0, 0] }, qualitative: true },
  { id: "hbsag", name: "HBsAg (Antígeno Austrália)", unit: "", category: "Sorologia", refRange: { M: [0, 0], F: [0, 0] }, qualitative: true },
  { id: "anti_hbs", name: "Anti-HBs (Hepatite B)", unit: "UI/L", category: "Sorologia", refRange: { M: [10, 999], F: [10, 999] } },
  { id: "anti_hbc_total", name: "Anti-HBc Total (Hepatite B)", unit: "", category: "Sorologia", refRange: { M: [0, 0], F: [0, 0] }, qualitative: true },
  { id: "anti_hcv", name: "Anti-HCV (Hepatite C)", unit: "", category: "Sorologia", refRange: { M: [0, 0], F: [0, 0] }, qualitative: true },
  { id: "sifilis_treponemico", name: "Sífilis (Anti-T. Pallidum)", unit: "", category: "Sorologia", refRange: { M: [0, 0], F: [0, 0] }, qualitative: true },
  { id: "sifilis_vdrl", name: "Sífilis VDRL (Cardiolipina)", unit: "", category: "Sorologia", refRange: { M: [0, 0], F: [0, 0] }, qualitative: true },
  { id: "toxoplasma_igg", name: "Toxoplasma IgG", unit: "UI/mL", category: "Sorologia", refRange: { M: [0, 1.6], F: [0, 1.6] } },
  { id: "toxoplasma_igm", name: "Toxoplasma IgM", unit: "", category: "Sorologia", refRange: { M: [0, 0], F: [0, 0] }, qualitative: true },
  { id: "vzv_igg", name: "Varicella-Zoster IgG", unit: "mIU/mL", category: "Sorologia", refRange: { M: [165, 999999], F: [165, 999999] } },
  { id: "vzv_igm", name: "Varicella-Zoster IgM", unit: "", category: "Sorologia", refRange: { M: [0, 0], F: [0, 0] }, qualitative: true },
  { id: "hsv_igm", name: "Herpes Simplex 1+2 IgM", unit: "", category: "Sorologia", refRange: { M: [0, 0], F: [0, 0] }, qualitative: true },
  { id: "hsv1_igg", name: "Herpes Simplex 1 IgG", unit: "", category: "Sorologia", refRange: { M: [0, 0], F: [0, 0] }, qualitative: true },
  { id: "hsv2_igg", name: "Herpes Simplex 2 IgG", unit: "", category: "Sorologia", refRange: { M: [0, 0], F: [0, 0] }, qualitative: true },
