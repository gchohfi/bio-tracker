...
export const MARKERS: MarkerDef[] = [
  ...
  { id: "anti_tpo", name: "Anti-TPO", unit: "UI/mL", category: "Tireoide", refRange: { M: [0, 34], F: [0, 34] } , panel: "Padrão" },
  ...
  { id: "copro_gordura_quant", name: "Gordura Fecal (%)", unit: "%", category: "Fezes", refRange: { M: [0, 5], F: [0, 5] } , panel: "Padrão" },
