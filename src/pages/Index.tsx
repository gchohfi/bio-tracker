          ...
          <section>
            <h2 className="mb-3 text-sm sm:text-base font-semibold flex items-center gap-2">
              ...
              <Badge variant="outline" className="text-[10px] h-4 px-1.5 border-primary/30 text-primary">
                {filteredImports.length} pendente{filteredImports.length > 1 ? "s" : ""}
              </Badge>
            </h2>
            <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
              {filteredImports.slice(0, isMobile ? 4 : 8).map((imp) => (
                <Card
                  key={imp.session_id}
                  className="cursor-pointer border-l-4 border-l-primary/40 hover:bg-muted/50 active:scale-[0.98] transition-all"
